            ...
            <div class="col-5">
                ...
                <form action="dashboard.php" method="GET">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="exampleFormControlTextarea1" name="paragrafo" rows="3" required></textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" name="bad-word" aria-label="default input example" required>
                    </div>
